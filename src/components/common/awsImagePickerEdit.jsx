...
const AWSImagePickerEdit = ({ name, label, error, showLabel, value, onChange, url, buttonText }) => {
  ...
  return (
    <div className="form-group">
      ...
      <div className="ImagePicker-Box-Edit">
        <input
          ref={myRef}
          accept="image/jpeg"
          type="file"
        ...
        />
        {url ? (
          <img src={url} className="image" width={"300px"} height={"300px"} style={{objectFit : "cover", borderRadius : 10}} alt="Resident"/>
        ) : (
          <div className="user-profile-box">
            <i className="fa fa-user fa-2x light-text" aria-hidden="true"></i>
          </div>
        )}
        <i className="fa fa-pencil-square-o fa-2x primary-text" aria-hidden="true" onClick={handleClick}></i>
...
export default AWSImagePickerEdit;
